  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        {/* Sign In Card */}
        <div className="rounded-lg backdrop-blur-sm p-8 shadow-2xl" style={{ background: 'var(--superficie)', border: '1px solid var(--borde)' }}>
          <div className="mb-6">
            <h1 className="text-center text-2xl font-bold text-tinta">
              {t('common.appName')}
            </h1>
            <h2 className="mt-2 text-center text-lg font-medium text-tinta-2">
              {t('auth.signIn')}
            </h2>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="email" className="block text-tinta">
                  {t('auth.email')}
                </Label>
                <Input
                  id="email"
              ...
              <div>
                <Label htmlFor="password" className="block text-tinta">
                  {t('auth.password')}
                </Label>
                <div className="relative mt-1">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-3 text-tinta-3 hover:text-tinta-2"
