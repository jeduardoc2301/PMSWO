            ...
            {consultants.map((c, idx) => {
              ...
              return (
                <button
                  ...
                  className="rounded-xl p-5 text-left transition-all hover:border-borde-fuerte flex flex-col gap-4"
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-semibold text-tinta truncate">{c.name}</div>
                      <div className="text-[11px] text-tinta-3 truncate">{c.email}</div>
                    </div>
                    {/* Health dot */}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5 text-xs">
                      <span className="text-tinta-3">Completitud</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight size={13} className="text-tinta-3" />
                  </div>
                </button>
              )
            })}
