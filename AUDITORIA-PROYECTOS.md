...
| 24 | Deshacer / rehacer (§10.6) | **CERRADA (tablero)** | `lib/projects/undo-stack.ts`, `components/projects/use-undo.ts` | Sólo el movimiento del tablero está enganchado (ver bitácora) | L | Bajo |
